...
CREATE INDEX IF NOT EXISTS idx_private_channels_user1 ON private_channel(user1_id);
CREATE INDEX IF NOT EXISTS idx_private_channels_user2 ON private_channel(user2_id);
